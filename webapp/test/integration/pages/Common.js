sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/SmartForm/app", ".html");
		...
		return Opa5.extend("com.SmartForm.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/SmartForm/localService/mockserver"], function (mockserver) {
